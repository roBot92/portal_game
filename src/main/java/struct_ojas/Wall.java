...
public class Wall {
	 ...
	 * 
	 * @param isSpecial
	 *            Megadhatjuk, hogy lehessen-e rajta csillagkaput létrehozni
	 * @param myField
	 *            A falat tartalmazó mezõ
	 */
	...
	/*
	 * /** Speciális fal létrehozása(így nem tartalmazhat ajtót), és Stargate
	 * átadása
	 * 
	 ...
	 * "Konstruktor: Wall - speciális, stargate-tel"); spec=true;
	...
	/*
	 * A fal kirajzoló függvénye. Függ az esetleges ajtótól, a fal pozíciójától
	 * és irányától, speciális mivoltától, illetve csillagkapu mivoltától.
	 * 
	...
	public void draw(Graphics g, int size, int orientation) {
		...
		// ha speciális, és van rajta nyitott csillagkapu, akkor a megfelelõ
		// csillagkapuszínû
		else if (this.spec) {
